        ...
        return (
            <div id="parentContainer" style={{color: '-webkit-link', cursor: 'pointer'}}>
                ...
                <div className="projectName">
                    ...
                    <a style={{float: "right", marginTop: "6px", marginRight: "5px"}}>{this.props.ratings}</a>
                    </h1>
                    <h2 className="caption" style={{marginTop: "-8px", marginBottom: "0px", fontSize:"1.1rem", color: "rgba(0, 0, 0, 0.8)", textAlign: "left"}} id="pCaption">{description}</h2>
                </div>
            </div>
        );
    }
