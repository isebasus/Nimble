    ...
    return(
        <div id="overlay" style = {styles.overlay}>
            <div id="togglebox" style = {{ paddingBottom: `${padding}`, animation: 'fade_in 0.25s'}}>
                <div style = {styles.image} id={imageClass}>
                ...
                <div className="right" style = {styles.right} id="rightdiv">
                    <h3 style = {styles.header}>Pricing</h3>
...
const BlankDescription = injectSheet(styles)(description);

export default BlankDescription;