    ...
    render() {
        return (
            <div>
                ...
                <a href="https://github.com/isebasus/" class="basket" id="g" onMouseOver={this.props.handleMouseOver} onMouseOut={this.props.handleMouseOut}>
                    <div style={{float: "right"}}>{this.status} Basket</div>
                    {this.props.isHovering && <ShoppingCart onMouseOver={this.props.handleMouseOver} onMouseOut={this.props.handleMouseOut}></ShoppingCart>}
                </a>
                </nav>
            </div>
        )
